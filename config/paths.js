...
module.exports = {
  ...
  appIndexJs: resolveModule(resolveApp, 'renderer/index'),
  appPackageJson: resolveApp('package.json'),
  appSrc: resolveApp('renderer'),
  appTsConfig: resolveApp('tsconfig.json'),
  yarnLockFile: resolveApp('yarn.lock'),
  testsSetup: resolveModule(resolveApp, 'renderer/setup-tests'),
  proxySetup: resolveApp('renderer/setup-proxy.js'),
